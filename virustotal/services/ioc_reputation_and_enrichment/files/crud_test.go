...
import (
	...
	"github.com/deploymenttheory/go-api-sdk-virustotal/virustotal/services/ioc_reputation_and_enrichment/files/mocks"
...
func TestUnitUploadFile_Success(t *testing.T) {
	...
	result, _, err := service.UploadFile(context.Background(), request)
	require.NoError(t, err)
...
func TestUnitGetFileReport_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetFileReport(context.Background(), "")
	require.Error(t, err)
...
func TestUnitRescanFile_Success(t *testing.T) {
	...
	result, _, err := service.RescanFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f")
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestUnitGetFileDownloadURL_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetFileDownloadURL(context.Background(), "")
	require.Error(t, err)
	assert.Contains(t, err.Error(), "file ID is required")
}
...
func TestUnitDownloadFile_Success(t *testing.T) {
	...
	result, _, err := service.DownloadFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f")
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestUnitGetCommentsOnFile_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetCommentsOnFile(context.Background(), "", nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "file ID is required")
}
...
func TestUnitAddCommentToFile_Success(t *testing.T) {
	...
	result, _, err := service.AddCommentToFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f", "This is a test comment")
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestUnitGetObjectDescriptorsRelatedToFile_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetObjectDescriptorsRelatedToFile(context.Background(), "", "contacted_domains", nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "file ID is required")
}
...
func TestUnitGetObjectDescriptorsRelatedToFile_EmptyRelationship(t *testing.T) {
	...
	_, _, err := service.GetObjectDescriptorsRelatedToFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f", "", nil)
	require.Error(t, err)
...
func TestUnitGetSigmaRule_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetSigmaRule(context.Background(), "")
	require.Error(t, err)
...
func TestUnitGetYARARuleset_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetYARARuleset(context.Background(), "")
	require.Error(t, err)
...
func TestUnitGetVotesOnFile_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetVotesOnFile(context.Background(), "", nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "file ID is required")
}
...
func TestUnitAddVoteToFile_Success(t *testing.T) {
	...
	result, _, err := service.AddVoteToFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f", "harmless")
	require.NoError(t, err)
	require.NotNil(t, result)
...
func TestUnitGetObjectsRelatedToFile_EmptyID(t *testing.T) {
	...
	_, _, err := service.GetObjectsRelatedToFile(context.Background(), "", RelationshipComments, nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "file ID is required")
}
...
func TestUnitGetObjectsRelatedToFile_EmptyRelationship(t *testing.T) {
	...
	_, _, err := service.GetObjectsRelatedToFile(context.Background(), "44d88612fea8a8f36de82e1278abb02f", "", nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "relationship is required")
}
