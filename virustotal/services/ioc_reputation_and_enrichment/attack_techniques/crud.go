...
type (
	...
	AttackTechniquesServiceInterface interface {
		...
		GetAttackTechnique(ctx context.Context, id string) (*AttackTechniqueResponse, error)
		...
		GetObjectsRelatedToAttackTechnique(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectsResponse, error)
		...
		GetObjectDescriptorsRelatedToAttackTechnique(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectDescriptorsResponse, error)
	}
...
func (s *Service) GetAttackTechnique(ctx context.Context, id string) (*AttackTechniqueResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack technique ID is required")
	}
...
func (s *Service) GetObjectsRelatedToAttackTechnique(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectsResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack technique ID is required")
	}
	if relationship == "" {
...
func (s *Service) GetObjectDescriptorsRelatedToAttackTechnique(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectDescriptorsResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack technique ID is required")
	}
	if relationship == "" {
