...
type (
	...
	AttackTacticsServiceInterface interface {
		...
		GetAttackTactic(ctx context.Context, id string) (*AttackTacticResponse, error)
		...
		GetObjectsRelatedToAttackTactic(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectsResponse, error)
		...
		GetObjectDescriptorsRelatedToAttackTactic(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectDescriptorsResponse, error)
	}
...
func (s *Service) GetAttackTactic(ctx context.Context, id string) (*AttackTacticResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack tactic ID is required")
	}
...
func (s *Service) GetObjectsRelatedToAttackTactic(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectsResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack tactic ID is required")
	}
	if relationship == "" {
...
func (s *Service) GetObjectDescriptorsRelatedToAttackTactic(ctx context.Context, id string, relationship string, opts *GetRelatedObjectsOptions) (*RelatedObjectDescriptorsResponse, error) {
	if id == "" {
		return nil, fmt.Errorf("attack tactic ID is required")
	}
	if relationship == "" {
