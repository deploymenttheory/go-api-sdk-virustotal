...
func TestPostForm_Success(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "form-test"})
	}))
	defer server.Close()
	...
	if result.ID != "form-test" {
		t.Errorf("ID = %q, want %q", result.ID, "form-test")
	}
}
...
func TestPostMultipart_Success(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "multipart-test"})
	}))
	defer server.Close()
	...
	if result.ID != "multipart-test" {
		t.Errorf("ID = %q, want %q", result.ID, "multipart-test")
	}
}

func TestPostMultipart_WithProgressCallback(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "progress-test"})
	}))
	defer server.Close()
...
func TestGetBytes_Success(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Query().Get("format") != "binary" {
			t.Errorf("Expected query param format=binary, got %s", r.URL.Query().Get("format"))
		}
...
func TestRequest_ErrorResponse(t *testing.T) {
	...
	if apiErr.Code != "InvalidArgumentError" {
		t.Errorf("Error code = %q, want %q", apiErr.Code, "InvalidArgumentError")
	}
}
...
func TestPostMultipart_NilFile(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "no-file"})
	}))
	defer server.Close()
	...
	if result.ID != "no-file" {
		t.Errorf("ID = %q, want %q", result.ID, "no-file")
	}
}

func TestPostMultipart_CustomReader(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "custom-reader"})
	}))
	defer server.Close()
	...
	if result.ID != "custom-reader" {
		t.Errorf("ID = %q, want %q", result.ID, "custom-reader")
	}
}
...
func TestPostForm_NilFormData(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "no-form"})
	}))
	defer server.Close()
	...
	if result.ID != "no-form" {
		t.Errorf("ID = %q, want %q", result.ID, "no-form")
	}
}

func TestPostForm_HeadersNotOverrideContentType(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Content-Type should be form-urlencoded, not json
		contentType := r.Header.Get("Content-Type")
		if contentType != "application/x-www-form-urlencoded" {
			t.Errorf("Expected Content-Type application/x-www-form-urlencoded, got %s", contentType)
		}
		...
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
		json.NewEncoder(w).Encode(testResponse{ID: "form-headers"})
	}))
	defer server.Close()
