...
TLS (Transport Layer Security) configuration controls how the SDK establishes secure HTTPS connections to the VirusTotal API. You can customize certificate validation, use mutual TLS, and set minimum TLS versions.
